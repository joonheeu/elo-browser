...
export function OnboardingIcon({ advance }: { advance: OnboardingAdvanceCallback }) {
  ...
  return (
    <>
      ...
      >
        <h1 className="mb-4 font-bold text-white text-4xl md:text-5xl">Choose your icon</h1>
        <p className="text-gray-400 text-lg">Select an icon for your Elo Browser</p>
      </motion.div>
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col justify-center items-center h-40 text-center">
            ...
            <div className="mb-1 font-medium text-white text-lg">Icon Customization Not Supported</div>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col justify-center">
                    <h3 className="font-medium text-white text-base truncate">{icon.name}</h3>
                    {icon.author && <p className="text-gray-400 text-xs truncate">by {icon.author}</p>}
                  </div>
                </div>
