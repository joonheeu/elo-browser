  ...
  return (
    <div className="flex flex-row justify-between items-center gap-4 hover:bg-muted/50 p-3 rounded-md transition-colors">
      <div className="flex-1 space-y-0.5">
        ...
        <p className="text-muted-foreground text-xs">Set Elo as your default browser.</p>
      </div>
      <div className="flex items-center gap-2">
        {isDefault === null && <Loader2Icon className="w-5 h-5 text-muted-foreground animate-spin" />}
        {isDefault === false && (
          <Button
