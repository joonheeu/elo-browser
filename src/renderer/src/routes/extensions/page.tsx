          ...
          <>
            <div className="mb-6">
              <div className="flex justify-between items-center">
                <div>
                  <h1 className="font-semibold text-foreground text-2xl">Elo Extensions</h1>
                  <p className="mt-1 text-muted-foreground">Manage your browser extensions</p>
                </div>
                <a
              ...
              <CardContent>
                ...
                {extensions.length > 0 ? (
                  ...
                  <div className="py-12 text-center">
                    <h3 className="mb-2 font-medium text-lg">No extensions installed</h3>
                    <p className="mb-6 text-muted-foreground">Install extensions to enhance your browsing experience</p>
