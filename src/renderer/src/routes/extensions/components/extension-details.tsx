    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex items-center space-x-3">
          <img src={extension.icon} alt={extension.name} className="rounded w-8 h-8" />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">{extension.description || "No description available"}</p>
        </div>
        ...
        {isDeveloperMode && (
          <>
            <div className="space-y-2">
              ...
              <p className="bg-muted p-2 rounded font-mono text-sm">{extension.id}</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1">
                  {extension.inspectViews.map((view) => (
                    <Button key={view} variant="link" className="p-0 h-auto text-sm">
                      {view}
                    </Button>
                  ))}
                </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-xs">
            Warning: Elo cannot prevent extensions from recording your browsing history. To disable this extension in
